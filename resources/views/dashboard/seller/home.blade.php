                ...
                <div class="bg-white p-6 rounded-lg shadow-sm border-l-4 border-gray-800">
                    <div class="flex items-center gap-4">
                        @if(Auth::user()->store->logo)
                            <img src="{{ '/storage/'. Auth::user()->store->logo }}" class="w-16 h-16 rounded-full object-cover border border-gray-200" loading="lazy" alt="{{ Auth::user()->store->name }} logo">
                        @else
                            <div class="w-16 h-16 rounded-full bg-gray-100 border border-gray-200"></div>
                        @endif
